...
const Footer = () => {
  ...
  return (
    <footer style={{ background: 'var(--bg-section)', padding: '6rem 0 3rem' }}>
      <div className="container">
        <div className="footer-grid">
          <div className="footer-col">
            <Link href="/" className="logo" style={{ fontFamily: 'Barlow Condensed', fontWeight: 900, letterSpacing: '1px', fontSize: '1.5rem', color: 'var(--brand-gold)' }}>
