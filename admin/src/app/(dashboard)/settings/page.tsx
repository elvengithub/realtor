...
import { 
  ...
  LayoutDashboard, Megaphone, Info, BarChart3, Calendar, Image as ImageIcon,
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between sticky top-0 bg-white z-10">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-brand-gold text-white px-6 py-2 rounded-xl font-bold hover:bg-brand-gold-deep transition-all shadow-md hover:shadow-lg active:scale-95 disabled:opacity-50"
            >
